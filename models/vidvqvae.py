...
class Quantizer(nn.Module):
    ...
    Args:
        dim: Dimension of codebook vector
        n_embed: Number of codebook vectors
    """
...
class Encoder(nn.Module):
    ...
    args:
        ...
        channel: intermediate channel count
        n_res_channel: residual intermediate channel count
        n_res_block: number of residual blocks
        stride: stride of initial conv. 4 for bottom encoding, 2 for top
    """
